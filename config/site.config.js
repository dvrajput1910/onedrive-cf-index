...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'dv1910@wisdumdum.com',
  ...
  footer:
    'Powered by <a href="https://google.com/" target="_blank" rel="noopener noreferrer">say my name</a>. Made with ❤',

  // [OPTIONAL] This is where you specify the folders that are password protected. It is an array of paths pointing to all
  // the directories in which you have .password set. Check the documentation for details.
  protectedRoutes: ["/OneDrive"],
